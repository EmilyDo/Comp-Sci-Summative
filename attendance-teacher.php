...
<!-- Nav Item - Dashboard -->
<li class="nav-item">
  <a class="nav-link" href="welcome-page.html">
...
<!-- Nav Item - Pages Collapse Menu -->
    ...
    <a class="nav-link" href="php/attendance-student.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          ...
          <span style="color: white; ">Math Resources</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="M.html">Fraction Calculator</a>
            <a class="collapse-item" href="fractions-calculator.html">Fraction Converter</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a style="color: white; " class="font-weight-bold nav-link" href="actual-login.php">
            <i class="fas fa-fw fa-clipboard-list"></i>
          <span>Attendance</span></a>
      </li>
 ...
 <!--
                    ...
                    <button class="second-button second">Absent</button>
                    <button class="right second">Late</button>
                    <button class="first-button third">Here</button>
                    <button class="second-button third">Absent</button>
                    <button class="right third">Late</button>
